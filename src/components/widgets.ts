...
export const WIDGETS: ComponentDef[] = [
  ...
  ),
  {
    ...
    kind: "widget",
    widget: "numbox",
    widgetConfig: { default: 440, min: 0, max: 20000, unit: "Hz" },
    tooltip: "Typed numeric entry with a range. Drag to adjust, click to type.",
    inputs: [],
    outputs: [{ label: "value" }],
  },
  {
    ...
    widget: "morphpad",
    tooltip:
      "Four corner snapshots of 8 control values, blended by the puck. Store the " +
      "current blend into a corner, or roll a random one.",
    inputs: [],
    outputs: Array.from({ length: 8 }, (_, i) => ({ label: `${i + 1}` })),
    resizable: true,
  ...
  },
  {
    ...
    kind: "widget",
    widget: "randomize",
    tooltip: "Rolls a new random value (0..1) and fires a trigger.",
    inputs: [],
    outputs: [{ label: "cv" }, { label: "trig" }],
  },
  {
    ...
    kind: "widget",
    widget: "panel-frame",
    tooltip: "A labelled frame for grouping part of a patch. No ports, no sound.",
    inputs: [],
    outputs: [],
    resizable: true,
  ...
  },
  {
    ...
    widget: "midi-out",
    tooltip:
      "Sends note on/off to a MIDI port from the gate and freq inputs (polled at " +
      "control rate, ~40 ms).",
    inputs: [{ label: "gate" }, { label: "freq" }],
    outputs: [],
  },
  {
    id: "midi-monitor",
    ...
    kind: "widget",
    widget: "midi-monitor",
    tooltip: "Scrolling log of incoming MIDI messages.",
    inputs: [],
    outputs: [],
    resizable: true,
    defaultSize: { w: 220, h: 110 },
  ...
  // ---- Metering & analysis ------------------------------------------------
  {
    ...
    widget: "correlation",
    tooltip:
      "Stereo phase correlation: +1 mono-compatible, 0 wide, negative cancels in mono.",
    inputs: [{ label: "L" }, { label: "R" }],
    outputs: [],
    resizable: true,
    defaultSize: { w: 150, h: 42 },
  },
  {
    id: "loudness",
    title: "Loudness",
    ...
    kind: "widget",
    widget: "loudness",
    tooltip: "Momentary loudness in LUFS plus peak dB, for the stereo bus.",
    inputs: [{ label: "L" }, { label: "R" }],
    outputs: [],
    resizable: true,
    defaultSize: { w: 130, h: 56 },
  },
  {
    id: "multiscope",
    title: "Scope x4",
    ...
    kind: "widget",
    widget: "multiscope",
    tooltip: "Four-trace oscilloscope. Channel 1 also triggers the sweep.",
    inputs: [{ label: "1" }, { label: "2" }, { label: "3" }, { label: "4" }],
    outputs: [],
    resizable: true,
  ...
  },
  {
    ...
    widget: "cv-plot",
    tooltip:
      "Scrolling plot of slow control signals (LFOs, envelopes, sequencer CV), autoscaled.",
    inputs: [{ label: "1" }, { label: "2" }, { label: "3" }, { label: "4" }],
    outputs: [],
    resizable: true,
  ...
  },
  {
    ...
    category: "Meters",
    kind: "widget",
    widget: "value-monitor",
    widgetConfig: { channels: 4 },
    tooltip: "Numeric readout of four signals, with the min/max seen so far.",
    inputs: [{ label: "1" }, { label: "2" }, { label: "3" }, { label: "4" }],
    outputs: [],
  },
  ...
  // ---- Sampling & files ---------------------------------------------------
  {
    ...
    kind: "widget",
    widget: "ir-loader",
    tooltip: "Convolution reverb: load an impulse response, blend dry/wet.",
    inputs: [{ label: "in" }],
    outputs: [{ label: "L" }, { label: "R" }],
  },
  {
    ...
    widget: "looper",
    tooltip:
      "Loop recorder: the first record pass sets the length, then play cycles it and " +
      "overdub layers on top. Up to 30 s.",
    inputs: [{ label: "in" }],
    outputs: [{ label: "out" }],
  },
];
